...
public class EndlessScrollRecyclerViewAdapter$ViewHolder_ViewBinding implements Unbinder {
  private GithubRepositoriesRecyclerViewAdapter.ViewHolder target;

  @UiThread
  public EndlessScrollRecyclerViewAdapter$ViewHolder_ViewBinding(GithubRepositoriesRecyclerViewAdapter.ViewHolder target,
      View source) {
    this.target = target;
